    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          String lastMessage =
              apc.getLastSentMessage(ap.allUsers[index].uid, ap.uid) ?? '';
          ...
          return ListTile(
            ...
            leading: CircleAvatar(
              backgroundColor: Theme.of(context).colorScheme.background,
              backgroundImage: NetworkImage(ap.allUsers[index].profilePicture),
            ),
            title: Text(
              ap.allUsers[index].name,
              style: const TextStyle(
                  color: Color(0xFF549762), fontWeight: FontWeight.bold),
            ),
            subtitle: Text(
              lastMessage,
